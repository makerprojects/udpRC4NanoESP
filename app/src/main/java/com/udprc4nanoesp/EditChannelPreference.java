...
public class EditChannelPreference extends EditTextPreference {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (working.length() == 1) {
                    try {
                        ...
                        Log.v(UdpServer.TAG, "Parsed num1 afterTextChanged: " + String.valueOf(num1));
    ...
    public void onDialogClosed (boolean positiveResult) {
        if (positiveResult) {
            Log.v(UdpServer.TAG, "onDialogClosed; num1= " + String.valueOf(num1));
            if (num1 < 1 || num1 > 8) {
                ...
                Log.v(UdpServer.TAG, "onDialogClosed retrieved " + output);
            }
        }
